...
<body>
    ...
    background-color: transparent !important; /* Elimina el fondo amarillo */
                    ...
                    @foreach($categoriasPadre as $categoriaPadre)
                        @if($categoriaPadre->subcategorias->count() > 0)
                            <div class="nav-item dropdown dropright">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">{{ $categoriaPadre->nombre }} <i class="fa fa-angle-right float-right mt-1"></i></a>
                                <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                    <a href="{{ route('productosVentas.categoria', $categoriaPadre->id) }}" class="dropdown-item font-weight-bold text-danger">{{ $categoriaPadre->nombre }}</a>
                                    @foreach($categoriaPadre->subcategorias as $subcategoria)
                                        <a href="{{ route('productosVentas.categoria', $subcategoria->id) }}" class="dropdown-item">{{ $subcategoria->nombre }}</a>
                                    @endforeach
                                </div>
                            </div>
                        @else
                            <a href="{{ route('productosVentas.categoria', $categoriaPadre->id) }}" class="nav-item nav-link">{{ $categoriaPadre->nombre }}</a>
                        @endif
                    @endforeach
                </div>
            </nav>
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav d-none d-lg-flex">
                        ...
                        <a href="{{ url('productosVentas') }}" class="nav-item nav-link text-white">Tienda</a>
        ...
        <div class="offcanvas-menu-body">
            <ul class="navbar-nav">
                ...
                @foreach($categoriasPadre as $categoriaPadre)
                    @if($categoriaPadre->subcategorias->count() > 0)
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">{{ $categoriaPadre->nombre }}</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('productosVentas.categoria', $categoriaPadre->id) }}" class="dropdown-item" style="background-color: #ffcccc;">{{ $categoriaPadre->nombre }}</a></li>
                                @foreach($categoriaPadre->subcategorias as $subcategoria)
                    ...
                    @else
                        <li class="nav-item"><a href="{{ route('productosVentas.categoria', $categoriaPadre->id) }}" class="nav-link">{{ $categoriaPadre->nombre }}</a></li>
                    @endif
                @endforeach
            </ul>
