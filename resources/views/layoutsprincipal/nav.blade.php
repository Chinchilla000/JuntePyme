    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="proceedToCheckoutButton" class="btn btn-primary"
                    onclick="proceedToCheckout()">Proceder al Pago</button>
            </div>
        </div>
    </div>
</div>
                ...
                if (window.innerWidth <= 991) {
                    ...
                    submenus.forEach(function(otherSubmenu) {
                        if (otherSubmenu !== submenu) {
                            ...
                            var otherDropdownMenu = otherSubmenu.querySelector(
                                '.dropdown-menu');
